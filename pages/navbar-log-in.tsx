          ...
          <a className="navbar-brand" href="#">
            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g mask="url(#mask0)">
                ...
                <path d="M41.5 35C52.3 38.2 49.6667 48 47 52.5L71 60.5L79.5 -13C63.6667 -13.8333 29.5 -15 19.5 -13C7.00001 -10.5 13.5 3.99999 12 14C10.5 24 28 31 41.5 35Z" fill="#4D17E2" />
                <path
